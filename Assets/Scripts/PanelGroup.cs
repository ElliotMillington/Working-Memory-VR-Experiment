...
public class PanelGroup : MonoBehaviour
{
    ...
    public GameObject TwoDimPrefab;
    public GameObject ThreeDimPrefab;
    ...
    {
        GameObject newPanel = (GameObject) PrefabUtility.InstantiatePrefab(TwoDimPrefab, this.transform);
    ...
    {
        GameObject newPanel = (GameObject) PrefabUtility.InstantiatePrefab((prefabName == "2D" ? TwoDimPrefab : ThreeDimPrefab), this.transform);
        newPanel.transform.localScale = new Vector3(1,1,1);
